...
impl wasi::types::Host for WasiCtx {
    /*async*/
    fn drop_fields(&mut self, _fields: Fields) -> wasmtime::Result<()> {
        anyhow::bail!("not implemented")
    }
    /*async*/
    fn new_fields(&mut self, _entries: Vec<(String, String)>) -> wasmtime::Result<Fields> {
        anyhow::bail!("not implemented")
    }
    /*async*/
    fn fields_get(&mut self, _fields: Fields, _name: String) -> wasmtime::Result<Vec<String>> {
        anyhow::bail!("not implemented")
    }
    /*async*/
    fn fields_set(
    ...
    /*async*/
    fn fields_delete(&mut self, _fields: Fields, _name: String) -> wasmtime::Result<()> {
        anyhow::bail!("not implemented")
    }
    /*async*/
    fn fields_append(
    ...
    /*async*/
    fn fields_entries(&mut self, _fields: Fields) -> wasmtime::Result<Vec<(String, String)>> {
        anyhow::bail!("not implemented")
    }
    /*async*/
    fn fields_clone(&mut self, _fields: Fields) -> wasmtime::Result<Fields> {
        anyhow::bail!("not implemented")
    }
    /*async*/
    ...
    /*async*/
    fn drop_outgoing_request(&mut self, _request: OutgoingRequest) -> wasmtime::Result<()> {
        anyhow::bail!("not implemented")
    }
    /*async*/
    ...
    /*async*/
    fn drop_incoming_response(&mut self, _response: IncomingResponse) -> wasmtime::Result<()> {
        anyhow::bail!("not implemented")
    }
    /*async*/
