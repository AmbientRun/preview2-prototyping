...
/*async */
fn instantiate(component: Component, wasi_ctx: WasiCtx) -> Result<(Store<WasiCtx>, Command)> {
...
/*async */
fn run_with_temp_dir(component: &str) -> Result<()> {
...
#[test]
/*async */
fn file_unbuffered_write() -> Result<()> {
...
#[test]
/*async */
fn path_open_create_existing() -> Result<()> {
...
#[test]
/*async */
fn path_open_dirfd_not_dir() -> Result<()> {
...
#[test]
/*async */
fn path_rename_dir_trailing_slashes() -> Result<()> {
...
#[test]
/*async */
fn path_rename_file_trailing_slashes() -> Result<()> {
...
#[test]
/*async */
fn path_symlink_trailing_slashes() -> Result<()> {
...
#[test]
/*async */
fn remove_directory_trailing_slashes() -> Result<()> {
...
#[test]
/*async */
fn remove_nonempty_directory() -> Result<()> {
...
#[test]
/*async */
fn unlink_file_trailing_slashes() -> Result<()> {
